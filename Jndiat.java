...
public class Jndiat extends MyPrinter {
	...
	public Jndiat (String args[]){
		...
		Namespace ns = null;
		ns = handlerErrorCatch(args, parser, ns);
	...
	private void deployOrUndeploy(Namespace ns) {
	...
	private void accessingMejb(Namespace ns) {
	...
	private void getSQLconnection(Namespace ns) {
	...
	private void listJndi(Namespace ns) {
	...
	private void searchValidCredential(Namespace ns) {
	...
	private void scanningT3(Namespace ns) {
	...
	private void setLevel(Namespace ns) {
